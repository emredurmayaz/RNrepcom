            ...
            <View style={{paddingHorizontal:5}}>
                ...
                <TouchableOpacity onPress={()=>this.setState({visible:true})} style={{left:-10,top:-50}}>
                    <LinearGradient
                        ...
                        style={{width:width*0.3,height:85, justifyContent:"center",alignItems:"center",alignSelf:"center", borderRadius: 100,}} >
                ...
                <Modal animationType="fade"  visible={this.state.visible} transparent onRequestClose={()=>console.log("a") }>
                    ...
                    <View style={{backgroundColor:"white", position:"absolute",height:280, width:width-40,top:(height-170)/2, borderRadius:20,marginHorizontal:25,paddingVertical: 20}}>
                        <FlatList
